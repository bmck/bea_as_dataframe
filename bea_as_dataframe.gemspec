...
require_relative "lib/bea_as_dataframe/version"

Gem::Specification.new do |spec|
  spec.name = "bea_as_dataframe"
  spec.version = BeaAsDataframe::VERSION
  spec.authors = ["Bill McKinnon"]
  spec.email = ["bill.mckinnon@bmck.org"]

  spec.summary       = 'Economic and financial data from BEA' 
  ...
  spec.metadata["changelog_uri"] = "https://github.com/bmck/bea_as_dataframe/CHANGELOG.md"
